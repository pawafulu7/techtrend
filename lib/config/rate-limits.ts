...
export const RATE_LIMIT_POLICIES: Record<string, RateLimitConfig> = {
  ...
  'read:popular': {
    ...
    blockDuration: 0,
    keyStrategy: 'ip',
    notes: 'Popular article rankings',
    telemetryEvent: 'ratelimit.read.popular',
  },
  'read:search': {
    points: 50,
    duration: 60,
  ...
  'read:diff-summary': {
    ...
    blockDuration: 0,
    keyStrategy: 'ip',
    notes: 'Diff summary weekly report (cached, public)',
    telemetryEvent: 'ratelimit.read.diff-summary',
  },
  'read:article-views': {
    points: 60,
    duration: 60,
    blockDuration: 0,
    keyStrategy: 'user',
    notes: 'Article view history read limit (60 per minute)',
    telemetryEvent: 'ratelimit.read.article-views',
  },
  'read:digest': {
    points: 30,
    duration: 60,
