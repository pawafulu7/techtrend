...
要約:
【必須】150文字以上180文字以下で記述。この範囲外は厳禁。
記事の核心的内容を簡潔にまとめる。最後は必ず句点で終了。

詳細要約:
【必須】合計500文字以上600文字以下。この範囲外は厳禁。
以下の5項目を箇条書きで記述。各項目は句点なし。

・主題と背景【100-120文字厳守】: 主要テーマと技術的文脈
・核心的内容【100-120文字厳守】: 最重要情報や発見
・具体的詳細【100-120文字厳守】: 実装方法や手順
・価値と効果【100-120文字厳守】: メリットや改善効果
・補足情報【100-120文字厳守】: 制約や注意点
