...
実際の値（本番用）：
```
DATABASE_URL = postgres://a35d3c8c7bf11c781a91ceb6459f0cea6108849c22755035c7fc1ca96010df71:sk_mFqvEAPErdH5KDtpPOaUT@db.prisma.io:5432/postgres?sslmode=require
```
